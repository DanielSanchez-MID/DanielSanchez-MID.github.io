...
function init() {
    ...
    let markerControl = new THREEx.ArMarkerControls(arToolkitContext, markerRoot1, {
        ...
        type: 'pattern', patternUrl: 'data/pattern-hello.patt',
    });
    ...
    new THREE.MTLLoader()
        .setPath('data/models/')
        .load('aleron1.mtl', function (materials) {
            materials.preload();
            new THREE.OBJLoader()
                .setMaterials(materials)
                .setPath('data/models/')
                .load('aleron1.obj', function (group) {
    ...
    new THREE.MTLLoader()
        .setPath('data/models/')
        .load('aleron2.mtl', function (materials) {
            materials.preload();
            new THREE.OBJLoader()
                .setMaterials(materials)
                .setPath('data/models/')
                .load('aleron2.obj', function (group) {
    ...
    new THREE.MTLLoader()
    .setPath('data/models/')
    .load('asiento.mtl', function (materials) {
        materials.preload();
        new THREE.OBJLoader()
            .setMaterials(materials)
            .setPath('data/models/')
            .load('asiento.obj', function (group) {
                RhinoMesh2 = group.children[0];
                RhinoMesh2.material.side = THREE.DoubleSide;
                RhinoMesh2.scale.set(0.05, 0.05, 0.05);
                RhinoMesh2.castShadow = true;
    ...
    new THREE.MTLLoader()
    .setPath('data/models/')
    .load('manubrio1.mtl', function (materials) {
        materials.preload();
        new THREE.OBJLoader()
            .setMaterials(materials)
            .setPath('data/models/')
            .load('manubrio1.obj', function (group) {
                RhinoMesh2 = group.children[0];
                RhinoMesh2.material.side = THREE.DoubleSide;
                RhinoMesh2.scale.set(0.05, 0.05, 0.05);
                RhinoMesh2.castShadow = true;
        ...
        new THREE.MTLLoader()
        .setPath('data/models/')
        .load('manubrio2.mtl', function (materials) {
            materials.preload();
            new THREE.OBJLoader()
                .setMaterials(materials)
                .setPath('data/models/')
                .load('manubrio2.obj', function (group) {
                    RhinoMesh2 = group.children[0];
                    RhinoMesh2.material.side = THREE.DoubleSide;
                    RhinoMesh2.scale.set(0.05, 0.05, 0.05);
                    RhinoMesh2.castShadow = true;
    ...
    .load('ruedas.mtl', function (materials) {
        ...
        new THREE.OBJLoader()
            .setMaterials(materials)
            .setPath('data/models/')
            .load('ruedas.obj', function (group) {
                RhinoMesh2 = group.children[0];
                RhinoMesh2.material.side = THREE.DoubleSide;
                RhinoMesh2.scale.set(0.05, 0.05, 0.05);
                RhinoMesh2.castShadow = true;
